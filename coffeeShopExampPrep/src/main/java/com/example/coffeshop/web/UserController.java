...
private final ModelMapper modelMapper;
    ...
    public String register(Model model){
        // IF I use this , should remove @ModelAttribute ..!

//        if (!model.containsAttribute("userRegisterBindingModel")){
//            model.addAttribute("userRegisterBindingModel",null);
//        }
    ...
    public String registerConfirm(@Valid UserRegisterBindingModel userRegisterBindingModel, BindingResult bindingResult, RedirectAttributes redirectAttributes){
        ...
        if (bindingResult.hasErrors() || !userRegisterBindingModel.getPassword().equals(userRegisterBindingModel.getPassword())){
